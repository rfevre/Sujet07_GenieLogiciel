...
class MyJTable extends JTable {
    public MyJTable(TableModel m) {super(m) ;}
	...
	String lastName = (String)model.getValueAt(rowIndex,0);
        ...
        if (realColumnIndex == 3) { // age ?
            tip = firstName + " " + lastName + " a " +
		model.getValueAt(rowIndex, 3) + " ans. " +
		"Modifiez cette valeur si c'est faux." ;
